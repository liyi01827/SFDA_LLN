...
class OfficeHome(ImageList):
    ...
    def __init__(self, root: str, task: str, r: float, download: Optional[bool] = False, **kwargs):
        ...
        super(OfficeHome, self).__init__(root, OfficeHome.CLASSES, data_list_file=data_list_file, r=r, **kwargs)
