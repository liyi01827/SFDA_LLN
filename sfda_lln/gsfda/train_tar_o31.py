...
def office_load_idx(args):
    ...
    t_tr, t_ts = '~/data/{}/images/{}.txt'.format(
        t, t), '~/data/{}/images/{}.txt'.format(t, t)
...
def train_target_near(args):
    ...
    modelpath = '~/da_weights/gsfda/office31/{}/source_F.pt'.format(args.dset[0])
    netF.load_state_dict(torch.load(modelpath))
    modelpath = '~/da_weights/gsfda/office31/{}/source_C.pt'.format(args.dset[0])
