...
def train_target(args):
    ...
    netF.load_state_dict(torch.load('~/da_weights/office-home/{}/source_F.pt'.format(weights_dir)))
    netC.load_state_dict(torch.load('~/da_weights/office-home/{}/source_C.pt'.format(weights_dir)))
